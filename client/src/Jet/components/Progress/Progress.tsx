...
const ProgressFillStyle = styled.div.attrs((props: any) => props)`
  position: absolute;
  top: 0;
  left: 0;
  height: 100%;
  width: ${props => props.value}%;
  background-color: ${props => props.theme.colors[props.color === 'secondary' ? 'background' : props.color || 'primary'][props.color === 'secondary' ? 4 : 0]};
  border-radius: ${props => props.theme.rounded};
