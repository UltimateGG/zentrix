...
const DateTimePickerStyle = styled.input.attrs((props: DateTimePickerProps) => props)`
  ...
  width: 100%;
  min-height: 2.4rem;
  color: ${props => props.theme.colors[props.disabled ? 'background' : 'text'][props.disabled ? 8 : 0]};
  background-color: ${props => props.theme.colors.background[props.disabled ? 2 : 1]};
  border: 1px solid ${props => props.theme.colors.background[props.disabled ? 2 : 5]};
...
const IconStyle = styled(Icon).attrs((props: DateTimePickerProps) => props)`
  ...
  & path {
    fill: ${props => props.theme.colors[props.disabled ? 'background' : 'text'][props.disabled ? 8 : 0]};
  }
`;
...
const XStyle = styled(Icon).attrs((props: DateTimePickerProps) => props)`
  ...
  color: ${props => props.theme.colors.background[7]};

  & path {
    fill: ${props => props.theme.colors.background[7]};
  }
`;
