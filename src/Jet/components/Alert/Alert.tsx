...
const AlertStyle = styled.div.attrs((props: AlertProps) => props)`
  ...
  background-color: ${props => {
    if (props.variant) {
      const col = hexToRgb(props.theme.colors[props.variant === 'secondary' ? 'background' : props.variant][0]);
  ...
  border: 2px solid ${props => props.theme.colors[(props.variant === 'secondary' ? 'background' : props.variant) || 'primary'][3]};
