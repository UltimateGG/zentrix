...
const DropdownStyle = styled.div.attrs((props: any) => props)`
  ...
  min-width: 130px;
  min-height: 2.4rem;
  background-color: ${props => props.theme.colors.background[props.disabled && props.variant === 'filled' ? 2 : 1]};
  border${props => props.variant === 'outlined' ? '-bottom' : ''}: ${props => props.variant === 'outlined' ? 2 : 1}px solid ${props=> props.theme.colors.background[props.disabled ? 2 : 5]};
  ...
  &:not([disabled]):hover {
    ${props => props.variant === 'filled' && `background-color: ${props.theme.colors.background[2]};`}
  }
  ...
  .selectedText {
    ...
    -ms-user-select: none;
    user-select: none;
    color: ${props => props.disabled ? props.theme.colors.background[8] : props.theme.colors.text[0]};
  }
`;
...
const ItemStyle = styled.div.attrs((props: DropdownProps) => props)`
  ...
  background-color: ${props => props.disabled ? props.theme.colors.background[1] : props.theme.colors.background[2]};
